...
import com.iceteaviet.fastfoodfinder.ui.ar.ARCamera;
import com.iceteaviet.fastfoodfinder.ui.ar.AROverlayView;
    ...
    public void onLocationChanged(Location location) {
        ...
        for (int i = 0; i < stores.size(); i++) {
            this.arOverlayView.addArPoint(new AugmentedPOI(stores.get(i).getTitle(),
                    ...
                    0,
                    MapUtils.getLogoDrawableId(stores.get(i).getType())));
        }
